...
plt.plot(theta_vals3, R_vals3, Marker = ".", color = "orange", markeredgewidth = 0.3, markerfacecolor = "k", markersize = 4.5, LineStyle = "none", label = "25% RH")
...
plt.savefig("phi0_0.1_Combo_plot.pdf") # change the name of the output graph pdf file here!