...
filenames = os.listdir(r"C:\Users\Matt\Documents\cprogramming\Python\Graphs\PHY3138\PHY3147\phi0_0.575_files") # use this for Mac
file_list = []
...
theta_model_vals = [] # a list of theta values to go with the correspnding interpolated R values

for filename in file_list:
    fpath = os.path.join(r"C:\Users\Matt\Documents\cprogramming\Python\Graphs\PHY3138\PHY3147\phi0_0.575_files", filename) # reads files from another directory
...
# # print(new_vals)
# x_new = new_vals["x"].tolist()
# y_new = new_vals["y"].tolist()
