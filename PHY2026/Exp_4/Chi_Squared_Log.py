...
def chi_squared(funct, x, y, x_errors, y_errors, w_initial):
    ...
    plt.errorbar(x, y, y_errors, x_errors, fmt = "r.", capsize = 4, elinewidth = 0.1, markeredgewidth = 0.3, markerfacecolor = "none", markersize = 7, LineStyle = "none", Label = "Data Points")
