...
def least_squares(funct, x, y, y_errors, w_initial):
    ...
    print("Sigma for least squares fit is: {:e}" .format(sigma))
    ...
    print("Gradient error for least squares fit is: {:e}\n" .format(grad_err))
    ...
    plt.savefig("Electron_Plot3.pdf")